...
var (
	...
	InventoryAssetNotFound = errors.New("Inventory_asset with this uid not found.")
)
...
type RestError struct {
	ErrStatus int         `json:"-"`
	ErrError  string      `json:"detail,omitempty"`
...
// New Inventory asset Not Found Error
func NewInventoryAssetNotFoundError(causes interface{}) RestErr {
	result := RestError{
		ErrStatus: http.StatusNotFound,
		ErrError:  InventoryAssetNotFound.Error(),
		ErrCauses: causes,
	}
	return result
}
